# Natural Language Toolkit: Hypergraph Corpus Reader
#
...
class HypergraphCorpusReader(XMLCorpusReader):
    ...
    def annotated_document(self, fn_docid):
        ...
        try:
            ...
            raise HypergraphError("Unknown document id: {0}".format(fn_docid))
    ...
    def frame_by_id(self, fn_fid, ignorekeys=[]):
        ...
        try:
            ...
            raise HypergraphError('Unknown frame id: {0}'.format(fn_fid))
    ...
    def frame_by_name(self, fn_fname, ignorekeys=[], check_cache=True):
        ...
        try:
            ...
            raise HypergraphError('Unknown frame: {0}'.format(fn_fname))
    ...
    def _lu_file(self, lu, ignorekeys=[]):
        ...
        try:
            ...
            raise HypergraphError('Unknown LU id: {0}'.format(fn_luid))
    ...
    def frame_relations(self, frame=None, frame2=None, type=None):
        ...
        if frame2 is not None:
            if frame is None:
                raise HypergraphError("frame_relations(frame=None, frame2=<value>) is not allowed")
            ...
            if frame==frame2:
                raise HypergraphError("The two frame arguments to frame_relations() must be different frames")
